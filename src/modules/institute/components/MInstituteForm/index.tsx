...
import { IMInstituteFormProps } from './types';

export const MInstituteForm: React.FC<IMInstituteFormProps> = ({ control }) => {
  return (
    <>
      <Stack direction="row" spacing={3} mb={2.5}>
        <Stack direction="column" spacing={1} flex={1}>
          <CFormLabel label="Tên trung tâm" htmlFor="name" required />
          <Controller
            control={control}
            name="name"
